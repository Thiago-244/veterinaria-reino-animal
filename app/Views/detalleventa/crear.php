...
<form method="POST" action="<?php echo APP_URL; ?>/detalleventa/crear/<?php echo (int)$venta['id']; ?>" class="form-container">
    ...
    <div class="form-actions">
        <button type="submit" class="btn-submit">Agregar Detalle</button>
