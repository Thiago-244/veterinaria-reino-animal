...
<form method="POST" action="<?php echo APP_URL; ?>/empresa/actualizar/<?php echo (int)$empresa['id']; ?>">
    ...
    <div class="form-group">
        ...
        <textarea id="direccion" name="direccion" required maxlength="255" 
                  placeholder="Dirección completa de la empresa"><?php echo htmlspecialchars($empresa['direccion']); ?></textarea>
    </div>
    ...
    <div class="form-actions">
        <button type="submit" class="btn-guardar">Actualizar Empresa</button>
