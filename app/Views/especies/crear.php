...
<h1 style="text-align:center">Añadir Nueva Especie</h1>
<?php if (!empty($error)): ?>
...
<form id="formEspecie" action="<?php echo APP_URL; ?>/apiespecie/crear" method="POST" autocomplete="off">
    <div class="form-group">
        ...
        <input type="text" id="nombre" name="nombre" required maxlength="50" 
               ...
               value="<?php echo isset($especie['nombre']) ? htmlspecialchars($especie['nombre']) : ''; ?>">
    ...
    <div style="display: flex; justify-content: center; gap: 20px; margin-top: 20px;">
        <button type="submit" style="min-width: 245px;">💾 Guardar Especie</button>
...
form.addEventListener('submit', function(e) {
    ...
    .then(res => {
        if (res.body.error) {
            ...
            setTimeout(() => {
                window.location = '<?php echo APP_URL; ?>/especie?success=1';
            }, 1500);
        } else {
