...
<form id="formUsuarioEdit" action="<?php echo APP_URL; ?>/apiusuario/actualizar/<?php echo (int)$usuario['id']; ?>" method="POST" autocomplete="off">
    ...
    <div class="form-group">
        ...
        <small class="help-text">Dejar vacío para mantener la contraseña actual. Mínimo 6 caracteres si se cambia.</small>
    </div>
    ...
    <div style="display: flex; justify-content: center; gap: 20px; margin-top: 20px;">
        <button type="submit" style="min-width: 200px;">✏️ Actualizar Usuario</button>
...
form.addEventListener('submit', function(e) {
    ...
    .then(res => {
        if (res.body.error) {
            ...
            setTimeout(() => {
                window.location = '<?php echo APP_URL; ?>/usuario?success=2';
            }, 1500);
        } else {
